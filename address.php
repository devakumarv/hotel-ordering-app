							  ...
							  <form action="" method="post">
                                 <div class="row">
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="firstname" id="example-text-input" placeholder="State"> 
                                    </div>
                                   <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">City</label>
                                       <input class="form-control" type="text" name="lastname" id="example-text-input-2" placeholder="City"> 
                                    </div> 
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Flat/Street/Landmark</label>
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Flat/Street/Landmark"> <small id="emailHelp" class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Zip Code</label>
                                       <input class="form-control" type="number" name="phone" id="example-tel-input-3" placeholder="Zip Code"> 
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="submit" value="Edit Address" name="submit" class="btn theme-btn"> </p>
                                    </div>
                                 </div>
                              </form>
